<html lang="en"><head>
    ...
    <title>{{ config('app.name', 'RedCross Dashboard') }}</title>
    <!-- Favicon -->
        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="col-12">
                                        ...
                                        <div class="card-body">
                        <form method="post" action="{{ route('profile.create') }}" autocomplete="off">
                            @csrf
                            @method('post')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}"
                                     value="" required>
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-phone">{{ __('password') }}</label>
                                    <input type="password" name="password" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="{{ __('Password') }}"
                                     value="" required>
                                ...
                                @if (auth()->user()->role=='head')
                                    ...
                                    <label class="form-control-label" for="input-check">{{ __('Checking Required') }}</label>
                                    <select name="check" id="input-check">
