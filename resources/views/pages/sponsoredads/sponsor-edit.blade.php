                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($Sponsored as $sponsor)
                            <form method="post" action="{{ url('sponsor-update/' . $sponsor->id) }}" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-lg-12 md-2">
                                        <div class="form-group{{ $errors->has('banner_title') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="banner_title" id="input-event" value="{{ $sponsor->banner_title}}"
                                        ...
                                        <div class="form-group{{ $errors->has('banner_image') ? ' has-danger' : '' }}">
                                            <label for="banner_image">Select image:</label>
                                            <input type="file" name="banner_image" id="banner_image" class="form-control form-control-alternative{{ $errors->has('banner_image') ? ' is-invalid' : '' }}">
                                            ...
                                            @if ($sponsor->banner_image)
                                                <img src="{{ asset($sponsor->banner_image) }}" alt="Current Image" class="img-fluid mt-2" style="max-width: 300px;">
                                            @endif
                                        </div>
                                    </div>
                                </div>
